...
| Pai | 00_conceito.md | 0.2.1 | BLOQUEADOR | #zonas-impacto |
| Pai | 01_arquitetura.md | 0.3.1 | BLOQUEADOR | #mod-sensor, #mapeamento-gpios, #interface-sensor-jogo, #requisitos-nao-funcionais |
| Pai | 05_alimentacao.md | 0.3.2 | BLOQUEADOR | #restricao-sensor |
